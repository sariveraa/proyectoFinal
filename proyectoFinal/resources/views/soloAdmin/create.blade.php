            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('administrar.store') }}">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="tipo" type="text" class="form-control @error('email') is-invalid @enderror" name="tipo" required autocomplete="email" >
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="passwordconfirm" type="password" class="form-control" name="passwordconfirmation" required autocomplete="new-password">
                                    </div>
                                </div>
